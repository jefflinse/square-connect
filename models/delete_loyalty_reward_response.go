...
func (m *DeleteLoyaltyRewardResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *DeleteLoyaltyRewardResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DeleteLoyaltyRewardResponse) UnmarshalBinary(b []byte) error {
	var res DeleteLoyaltyRewardResponse
