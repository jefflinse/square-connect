...
// CreateTerminalRefundResponse create terminal refund response
...
func (m *CreateTerminalRefundResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *CreateTerminalRefundResponse) validateRefund(formats strfmt.Registry) error {
...
func (m *CreateTerminalRefundResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CreateTerminalRefundResponse) contextValidateRefund(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CreateTerminalRefundResponse) UnmarshalBinary(b []byte) error {
	var res CreateTerminalRefundResponse
