...
func (o *CreateDisputeEvidenceTextReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCreateDisputeEvidenceTextOK()
...
func NewCreateDisputeEvidenceTextOK() *CreateDisputeEvidenceTextOK {
	return &CreateDisputeEvidenceTextOK{}
}

/*CreateDisputeEvidenceTextOK handles this case with default header values.
...
func (o *CreateDisputeEvidenceTextOK) Error() string {
	return fmt.Sprintf("[POST /v2/disputes/{dispute_id}/evidence_text][%d] createDisputeEvidenceTextOK  %+v", 200, o.Payload)
}
...
func (o *CreateDisputeEvidenceTextOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.CreateDisputeEvidenceTextResponse)
