...
func (o *RemoveGroupFromCustomerReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewRemoveGroupFromCustomerOK()
...
func NewRemoveGroupFromCustomerOK() *RemoveGroupFromCustomerOK {
	return &RemoveGroupFromCustomerOK{}
}

/*RemoveGroupFromCustomerOK handles this case with default header values.
...
func (o *RemoveGroupFromCustomerOK) Error() string {
	return fmt.Sprintf("[DELETE /v2/customers/{customer_id}/groups/{group_id}][%d] removeGroupFromCustomerOK  %+v", 200, o.Payload)
}
...
func (o *RemoveGroupFromCustomerOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.RemoveGroupFromCustomerResponse)
