...
func (o *RetrieveBookingOK) Error() string {
	return fmt.Sprintf("[GET /v2/bookings/{booking_id}][%d] retrieveBookingOK  %+v", 200, o.Payload)
}
func (o *RetrieveBookingOK) GetPayload() *models.RetrieveBookingResponse {
	return o.Payload
}

func (o *RetrieveBookingOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.RetrieveBookingResponse)
