...
func (o *DeleteCustomerCardReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteCustomerCardOK()
...
func NewDeleteCustomerCardOK() *DeleteCustomerCardOK {
	return &DeleteCustomerCardOK{}
}

/*DeleteCustomerCardOK handles this case with default header values.
...
func (o *DeleteCustomerCardOK) Error() string {
	return fmt.Sprintf("[DELETE /v2/customers/{customer_id}/cards/{card_id}][%d] deleteCustomerCardOK  %+v", 200, o.Payload)
}
...
func (o *DeleteCustomerCardOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.DeleteCustomerCardResponse)
