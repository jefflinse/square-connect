...
for the list categories operation typically these are written to a http.Request
*/
...
// WithLocationID adds the locationID to the list categories params
func (o *ListCategoriesParams) WithLocationID(locationID string) *ListCategoriesParams {
	o.SetLocationID(locationID)
	return o
}

// SetLocationID adds the locationId to the list categories params
func (o *ListCategoriesParams) SetLocationID(locationID string) {
