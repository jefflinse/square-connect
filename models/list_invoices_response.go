...
func (m *ListInvoicesResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ListInvoicesResponse) contextValidateInvoices(ctx context.Context, formats strfmt.Registry) error {
