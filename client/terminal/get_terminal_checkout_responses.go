...
func (o *GetTerminalCheckoutReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetTerminalCheckoutOK()
...
func NewGetTerminalCheckoutOK() *GetTerminalCheckoutOK {
	return &GetTerminalCheckoutOK{}
}

/*GetTerminalCheckoutOK handles this case with default header values.
...
func (o *GetTerminalCheckoutOK) Error() string {
	return fmt.Sprintf("[GET /v2/terminals/checkouts/{checkout_id}][%d] getTerminalCheckoutOK  %+v", 200, o.Payload)
}
...
func (o *GetTerminalCheckoutOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.GetTerminalCheckoutResponse)
