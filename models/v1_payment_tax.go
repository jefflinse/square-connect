...
// ContextValidate validate this v1 payment tax based on the context it is used
func (m *V1PaymentTax) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1PaymentTax) contextValidateAppliedMoney(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1PaymentTax) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
