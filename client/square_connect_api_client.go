...
import (
	...
	"github.com/jefflinse/square-connect/client/bookings"
...
// NewHTTPClient creates a new square connect API HTTP client.
func NewHTTPClient(formats strfmt.Registry) *SquareConnectAPI {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new square connect API HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *SquareConnectAPI {
...
// New creates a new square connect API client
func New(transport runtime.ClientTransport, formats strfmt.Registry) *SquareConnectAPI {
	// ensure nullable parameters have default
	if formats == nil {
		formats = strfmt.Default
	}

	cli := new(SquareConnectAPI)
...
// SquareConnectAPI is a client for square connect API
type SquareConnectAPI struct {
...
func (c *SquareConnectAPI) SetTransport(transport runtime.ClientTransport) {
