...
func (o *SearchTerminalRefundsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewSearchTerminalRefundsOK()
...
func NewSearchTerminalRefundsOK() *SearchTerminalRefundsOK {
	return &SearchTerminalRefundsOK{}
}
...
func (o *SearchTerminalRefundsOK) Error() string {
	return fmt.Sprintf("[POST /v2/terminals/refunds/search][%d] searchTerminalRefundsOK  %+v", 200, o.Payload)
}
func (o *SearchTerminalRefundsOK) GetPayload() *models.SearchTerminalRefundsResponse {
	return o.Payload
}

func (o *SearchTerminalRefundsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.SearchTerminalRefundsResponse)
