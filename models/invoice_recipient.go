...
func (m *InvoiceRecipient) validateCustomerID(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("customer_id", "body", m.CustomerID, 255); err != nil {
		return err
	}
...
func (m *InvoiceRecipient) contextValidateAddress(ctx context.Context, formats strfmt.Registry) error {
