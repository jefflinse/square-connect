...
func (m *Dispute) validateBrandDisputeID(formats strfmt.Registry) error {
	...
	if err := validate.MinLength("brand_dispute_id", "body", string(m.BrandDisputeID), 1); err != nil {
		return err
	}

	if err := validate.MaxLength("brand_dispute_id", "body", string(m.BrandDisputeID), 40); err != nil {
		return err
	}
...
func (m *Dispute) validateCreatedAt(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("created_at", "body", string(m.CreatedAt), 40); err != nil {
		return err
	}
...
func (m *Dispute) validateDueAt(formats strfmt.Registry) error {
	...
	if err := validate.MinLength("due_at", "body", string(m.DueAt), 1); err != nil {
		return err
	}

	if err := validate.MaxLength("due_at", "body", string(m.DueAt), 40); err != nil {
		return err
	}
...
func (m *Dispute) validateEvidenceIds(formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.EvidenceIds); i++ {
		...
		if err := validate.MinLength("evidence_ids"+"."+strconv.Itoa(i), "body", string(m.EvidenceIds[i]), 1); err != nil {
			return err
		}
...
func (m *Dispute) validateReportedDate(formats strfmt.Registry) error {
	...
	if err := validate.MinLength("reported_date", "body", string(m.ReportedDate), 1); err != nil {
		return err
	}

	if err := validate.MaxLength("reported_date", "body", string(m.ReportedDate), 40); err != nil {
		return err
	}
...
func (m *Dispute) validateUpdatedAt(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("updated_at", "body", string(m.UpdatedAt), 40); err != nil {
		return err
	}
