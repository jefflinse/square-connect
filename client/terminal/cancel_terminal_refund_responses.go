...
func (o *CancelTerminalRefundReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCancelTerminalRefundOK()
...
func (o *CancelTerminalRefundOK) Error() string {
	return fmt.Sprintf("[POST /v2/terminals/refunds/{terminal_refund_id}/cancel][%d] cancelTerminalRefundOK  %+v", 200, o.Payload)
}
func (o *CancelTerminalRefundOK) GetPayload() *models.CancelTerminalRefundResponse {
	return o.Payload
}

func (o *CancelTerminalRefundOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.CancelTerminalRefundResponse)
