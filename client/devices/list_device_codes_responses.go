...
func NewListDeviceCodesOK() *ListDeviceCodesOK {
	return &ListDeviceCodesOK{}
}

/*ListDeviceCodesOK handles this case with default header values.
...
func (o *ListDeviceCodesOK) Error() string {
	return fmt.Sprintf("[GET /v2/devices/codes][%d] listDeviceCodesOK  %+v", 200, o.Payload)
}
...
func (o *ListDeviceCodesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.ListDeviceCodesResponse)
