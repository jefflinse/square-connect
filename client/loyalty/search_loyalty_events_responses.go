...
func (o *SearchLoyaltyEventsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewSearchLoyaltyEventsOK()
...
func NewSearchLoyaltyEventsOK() *SearchLoyaltyEventsOK {
	return &SearchLoyaltyEventsOK{}
}

/*SearchLoyaltyEventsOK handles this case with default header values.
...
func (o *SearchLoyaltyEventsOK) Error() string {
	return fmt.Sprintf("[POST /v2/loyalty/events/search][%d] searchLoyaltyEventsOK  %+v", 200, o.Payload)
}
...
func (o *SearchLoyaltyEventsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.SearchLoyaltyEventsResponse)
