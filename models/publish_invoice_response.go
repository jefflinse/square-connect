...
func (m *PublishInvoiceResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *PublishInvoiceResponse) validateInvoice(formats strfmt.Registry) error {
...
func (m *PublishInvoiceResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PublishInvoiceResponse) contextValidateInvoice(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PublishInvoiceResponse) UnmarshalBinary(b []byte) error {
	var res PublishInvoiceResponse
