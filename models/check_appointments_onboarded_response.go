...
func (m *CheckAppointmentsOnboardedResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CheckAppointmentsOnboardedResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *CheckAppointmentsOnboardedResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CheckAppointmentsOnboardedResponse) UnmarshalBinary(b []byte) error {
	var res CheckAppointmentsOnboardedResponse
