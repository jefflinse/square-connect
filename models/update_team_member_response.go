...
func (m *UpdateTeamMemberResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UpdateTeamMemberResponse) contextValidateTeamMember(ctx context.Context, formats strfmt.Registry) error {
