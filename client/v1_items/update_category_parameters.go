...
func (o *UpdateCategoryParams) WithBody(body *models.V1Category) *UpdateCategoryParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update category params
func (o *UpdateCategoryParams) SetBody(body *models.V1Category) {
	o.Body = body
}

// WithCategoryID adds the categoryID to the update category params
func (o *UpdateCategoryParams) WithCategoryID(categoryID string) *UpdateCategoryParams {
	o.SetCategoryID(categoryID)
	return o
}

// SetCategoryID adds the categoryId to the update category params
func (o *UpdateCategoryParams) SetCategoryID(categoryID string) {
	o.CategoryID = categoryID
}

// WithLocationID adds the locationID to the update category params
func (o *UpdateCategoryParams) WithLocationID(locationID string) *UpdateCategoryParams {
	o.SetLocationID(locationID)
	return o
}

// SetLocationID adds the locationId to the update category params
func (o *UpdateCategoryParams) SetLocationID(locationID string) {
