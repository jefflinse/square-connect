...
func (m *CreateCustomerGroupResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *CreateCustomerGroupResponse) validateGroup(formats strfmt.Registry) error {
...
func (m *CreateCustomerGroupResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CreateCustomerGroupResponse) contextValidateGroup(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CreateCustomerGroupResponse) UnmarshalBinary(b []byte) error {
	var res CreateCustomerGroupResponse
