...
func (m *OnboardAppointmentsResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *OnboardAppointmentsResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OnboardAppointmentsResponse) UnmarshalBinary(b []byte) error {
	var res OnboardAppointmentsResponse
