...
func (m *DeleteCustomerCardResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *DeleteCustomerCardResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DeleteCustomerCardResponse) UnmarshalBinary(b []byte) error {
	var res DeleteCustomerCardResponse
