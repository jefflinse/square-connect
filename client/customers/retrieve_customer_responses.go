...
func NewRetrieveCustomerOK() *RetrieveCustomerOK {
	return &RetrieveCustomerOK{}
}

/*RetrieveCustomerOK handles this case with default header values.
...
func (o *RetrieveCustomerOK) Error() string {
	return fmt.Sprintf("[GET /v2/customers/{customer_id}][%d] retrieveCustomerOK  %+v", 200, o.Payload)
}
...
func (o *RetrieveCustomerOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.RetrieveCustomerResponse)
