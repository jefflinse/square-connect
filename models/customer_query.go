...
func (m *CustomerQuery) contextValidateFilter(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CustomerQuery) contextValidateSort(ctx context.Context, formats strfmt.Registry) error {
