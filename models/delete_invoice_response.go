...
func (m *DeleteInvoiceResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *DeleteInvoiceResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
