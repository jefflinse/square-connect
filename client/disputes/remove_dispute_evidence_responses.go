...
func (o *RemoveDisputeEvidenceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewRemoveDisputeEvidenceOK()
...
func NewRemoveDisputeEvidenceOK() *RemoveDisputeEvidenceOK {
	return &RemoveDisputeEvidenceOK{}
}

/*RemoveDisputeEvidenceOK handles this case with default header values.
...
func (o *RemoveDisputeEvidenceOK) Error() string {
	return fmt.Sprintf("[DELETE /v2/disputes/{dispute_id}/evidence/{evidence_id}][%d] removeDisputeEvidenceOK  %+v", 200, o.Payload)
}
...
func (o *RemoveDisputeEvidenceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.RemoveDisputeEvidenceResponse)
