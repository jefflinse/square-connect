...
func (o *SearchTerminalCheckoutsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewSearchTerminalCheckoutsOK()
...
func NewSearchTerminalCheckoutsOK() *SearchTerminalCheckoutsOK {
	return &SearchTerminalCheckoutsOK{}
}

/*SearchTerminalCheckoutsOK handles this case with default header values.
...
func (o *SearchTerminalCheckoutsOK) Error() string {
	return fmt.Sprintf("[POST /v2/terminals/checkouts/search][%d] searchTerminalCheckoutsOK  %+v", 200, o.Payload)
}
...
func (o *SearchTerminalCheckoutsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.SearchTerminalCheckoutsResponse)
