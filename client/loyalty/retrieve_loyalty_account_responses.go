...
func (o *RetrieveLoyaltyAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewRetrieveLoyaltyAccountOK()
...
func NewRetrieveLoyaltyAccountOK() *RetrieveLoyaltyAccountOK {
	return &RetrieveLoyaltyAccountOK{}
}

/*RetrieveLoyaltyAccountOK handles this case with default header values.
...
func (o *RetrieveLoyaltyAccountOK) Error() string {
	return fmt.Sprintf("[GET /v2/loyalty/accounts/{account_id}][%d] retrieveLoyaltyAccountOK  %+v", 200, o.Payload)
}
...
func (o *RetrieveLoyaltyAccountOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.RetrieveLoyaltyAccountResponse)
