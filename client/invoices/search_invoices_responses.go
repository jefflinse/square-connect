...
func (o *SearchInvoicesOK) Error() string {
	return fmt.Sprintf("[POST /v2/invoices/search][%d] searchInvoicesOK  %+v", 200, o.Payload)
}
func (o *SearchInvoicesOK) GetPayload() *models.SearchInvoicesResponse {
	return o.Payload
}
...
func (o *SearchInvoicesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.SearchInvoicesResponse)
