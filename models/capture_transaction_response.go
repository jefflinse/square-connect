...
func (m *CaptureTransactionResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *CaptureTransactionResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CaptureTransactionResponse) UnmarshalBinary(b []byte) error {
	var res CaptureTransactionResponse
