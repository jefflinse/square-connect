...
func (o *RetrieveInventoryPhysicalCountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewRetrieveInventoryPhysicalCountOK()
...
func NewRetrieveInventoryPhysicalCountOK() *RetrieveInventoryPhysicalCountOK {
	return &RetrieveInventoryPhysicalCountOK{}
}

/*RetrieveInventoryPhysicalCountOK handles this case with default header values.
...
func (o *RetrieveInventoryPhysicalCountOK) Error() string {
	return fmt.Sprintf("[GET /v2/inventory/physical-count/{physical_count_id}][%d] retrieveInventoryPhysicalCountOK  %+v", 200, o.Payload)
}
...
func (o *RetrieveInventoryPhysicalCountOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.RetrieveInventoryPhysicalCountResponse)
