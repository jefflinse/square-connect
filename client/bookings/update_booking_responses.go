...
func (o *UpdateBookingOK) Error() string {
	return fmt.Sprintf("[PUT /v2/bookings/{booking_id}][%d] updateBookingOK  %+v", 200, o.Payload)
}
func (o *UpdateBookingOK) GetPayload() *models.UpdateBookingResponse {
	return o.Payload
}

func (o *UpdateBookingOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.UpdateBookingResponse)
